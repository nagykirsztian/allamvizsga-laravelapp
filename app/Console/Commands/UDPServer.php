...
//     $serverAddress = '228.0.0.1'; // Your server's IP address
//     $serverPorts = [50076, 8001, 8002, 8003, 8004]; // Ports for each sensor
...
//                 // Check if the received data matches the expected format
//                 if (preg_match('/^\[(\d)(\d{2})([ABC])(\d{1,10})\d{3}\]$/', $data, $matches)) 
//                     {
//                     $location = $matches[1];
//                     $id = $matches[2];
//                     $method = $matches[3];
...
//                         $post->value = $value;
//                         $post->location = $location; // Set the location
